...
export class titleScreen extends Phaser.Scene {
  ...
  create() {
    ...
    <div>
      <button id="singlePlayButton" style="border:none;cursor:pointer;margin:60px;display:block;border-radius:5px;width:200px;height:60px;font-size:20px;font-weight:bold;">始める</button>
    </div>`);
    buttonDom
